...
use Popolitinero\AdminBundle\Form\CityType;
...
class CityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PopolitineroDefaultBundle:City')->findAll();
     ...
     *
     * @Route("/{hubslug}/show", name="city_show")
     * @Template()
     */
    public function showAction($hubslug)
    {
        $em = $this->getDoctrine()->getEntityManager();

        $entities = $em->getRepository('PopolitineroDefaultBundle:City')->findByHubSlug($hubslug);

        $deleteForm = $this->createDeleteForm($hubslug);
     ...
     * @Method("post")
     * @Template("PopolitineroDefaultBundle:City:new.html.twig")
     */
    ...
    public function editAction($id)
    {
        ...
        $entity = $em->getRepository('PopolitineroDefaultBundle:City')->find($id);
     ...
     * @Method("post")
     * @Template("PopolitineroDefaultBundle:City:edit.html.twig")
     */
